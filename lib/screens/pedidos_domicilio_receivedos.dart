...
class PedidosRecividosDomicilio extends StatefulWidget {
  static const String id = '/pedidosreceivedos';
  const PedidosRecividosDomicilio({Key? key}) : super(key: key);

  @override
  _PedidosRecividosDomicilioState createState() => _PedidosRecividosDomicilioState();
}

class _PedidosRecividosDomicilioState extends State<PedidosRecividosDomicilio> {
  @override
          ...
          Padding(
            ...
            child: Container(
                ...
                child: Padding(
                  ...
                  child: Center(
                      child: Text(
                    'Pedidos recibidos :entrega a domicilio',
