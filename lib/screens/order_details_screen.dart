                        ...
                        return Padding(
                          ...
                          child: Card(
                              ...
                              child:Padding(
                                ...
                                Text(' ${list[index]['qty']}'),
                                Text(' Precio total '),
                                Text('  ${list[index]['product_total_price']}'),
                                Text(' Precio base '),
                                Text('  ${list[index]['product_total_base']}'),
                                Text(' Total descuentos'),
                                Text(' ${list[index]['product_total_discount']}'),
                                Text(' Total impuestos'),
                                Text(' Total impuestos${list[index]['product_total_taxes']}'),
