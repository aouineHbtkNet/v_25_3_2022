...
class PedidosEntregadosDomicilio extends StatefulWidget {
  static const String id = '/PedidosEntregados';
  const PedidosEntregadosDomicilio({Key? key}) : super(key: key);

  @override
  _PedidosEntregadosDomicilioState createState() => _PedidosEntregadosDomicilioState();
}

class _PedidosEntregadosDomicilioState extends State<PedidosEntregadosDomicilio> {
  @override
