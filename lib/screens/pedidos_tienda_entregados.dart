...
class PedidosEntregadosTienda extends StatefulWidget {
  static const String id = '/PedidosEntregadosTienda';
  const PedidosEntregadosTienda({Key? key}) : super(key: key);

  @override
  _PedidosEntregadosTiendaState createState() => _PedidosEntregadosTiendaState();
}

class _PedidosEntregadosTiendaState extends State<PedidosEntregadosTienda> {
  @override
              ...
              Padding(
                ...
                child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Center(
                          child: Text(
                            'Pedidos entregados : entrega en la tienda',
