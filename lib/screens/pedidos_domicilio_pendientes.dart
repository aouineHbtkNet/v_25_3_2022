...
class PedidosPendientesDomicilio extends StatefulWidget {
  static const String id = '/PedidosPendientes';
  const PedidosPendientesDomicilio({Key? key}) : super(key: key);

  @override
  _PedidosPendientesDomicilioState createState() => _PedidosPendientesDomicilioState();
}

class _PedidosPendientesDomicilioState extends State<PedidosPendientesDomicilio> {
  @override
